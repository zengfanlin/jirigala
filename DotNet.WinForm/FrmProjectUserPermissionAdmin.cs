...
{
    using DotNet.Model;
    using DotNet.WinForm.Permission;
    ...
    public partial class FrmProjectUserPermissionAdmin : FrmUserPermissionAdmin
    {
        ...
        protected override void btnPermission_Click(object sender, EventArgs e)
        {
            ...
            // 资源分类
            string resourceCategory = BaseUserTable.TableName;
            // 资源主键
            ...
            // 目标视图
            string targetSQL = "SELECT Id, RealName, Description FROM Base_Project WHERE DeletionStateCode = 0 AND Enabled = 1 ORDER BY SortCode";
            // 这里调用个性化的权限设置窗体
